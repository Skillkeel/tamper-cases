...
See [RESULTS.md](RESULTS.md). First rows: skillkeel-starter guard-bash 0.1.0 (2026-09-14) and 0.1.5 (2026-09-17): destructive 17/21 then 21/21, git-config-exec 0/12 then 12/12, guard-file-tamper 1/40 both (out of scope, no protected paths), 0 false positives on the 22 benign forms.
